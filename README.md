...
| File | Purpose |
|------|---------|
| `index.html` | The single-page site (hero, about, method, work, company, contact) |
...
- **Hero** — headline and key stats
- **About** — entrepreneur profile and focus areas
- **Method** — the 8-D framework (Discover → Drive)
- **Work** — selected products (amanoba, messmass, hatori, narimato, reply, sso, spot, …)
